...
export default function Privacy() {
  return (
    <Layout title="Privacy Policy">
      <section>
        <h1>Privacy Policy for Larven Syndicate Limited</h1>
        <p>
    At Larven, accessible from https://www.larven.co.tz, one of our main
    priorities is the privacy of our visitors. This Privacy Policy document
    contains types of information that is collected and recorded by Larven and
    how we use it.
        </p>
        <p>
    ...
    and/or collect in Larven. This policy is not applicable to any information
    ...
    telephone number.
      ...
      purposes
        ...
        <h2>Log Files</h2>
        <p>
    Larven follows a standard procedure of using log files. These files log
    ...
    advertising partners of Larven.
        </p>
        <p>
    Third-party ad servers or ad networks uses technologies like cookies,
    JavaScript, or Web Beacons that are used in their respective advertisements
    and links that appear on Larven, which are sent directly to users&apos; browser.
    ...
    websites that you visit.
        ...
        <p>
    Note that Larven has no access to or control over these cookies that are
    used by third-party advertisers.
        </p>
        <h2>Third Party Privacy Policies</h2>
        <p>
    Larven&apos;s Privacy Policy does not apply to other advertisers or websites.
    ...
    protection rights. Every user is entitled to the following:
        ...
        <p>
    The right to access &ndash; You have the right to request copies of your personal
    data. We may charge you a small fee for this service.
        </p>
        <p>
    The right to rectification &ndash; You have the right to request that we correct
    ...
    request that we complete the information you believe is incomplete.
        ...
        <p>
    The right to erasure &ndash; You have the right to request that we erase your
    personal data, under certain conditions.
        </p>
        <p>
    The right to restrict processing &ndash; You have the right to request that we
    restrict the processing of your personal data, under certain conditions.
        </p>
        <p>
    The right to object to processing &ndash; You have the right to object to our
    ...
    and/or monitor and guide their online activity.
        ...
        <p>
    Larven does not knowingly collect any Personal Identifiable Information from
