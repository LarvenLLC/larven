  ...
  return (
    <Layout title="Terms and Conditions">
      <section>
        ...
        <p>Welcome to Larven!</p>
        <p>
    These terms and conditions outline the rules and regulations for the use of
    Larven Syndicate Limited&apos;s Website, located at https://www.larven.co.tz.
        </p>
        <p>
    By accessing this website we assume you accept these terms and conditions.
    Do not continue to use Larven if you do not agree to take all of the terms
    ...
    interchangeable and therefore as referring to same.
        ...
        <p>
    We employ the use of cookies. By accessing Larven, you agreed to use cookies
    in agreement with the Larven Syndicate Limited&apos;s Privacy Policy.{' '}
        </p>
        <p>
    ...
    our affiliate/advertising partners may also use cookies.
        ...
        <p>
    Unless otherwise stated, Larven Syndicate Limited and/or its licensors own
    the intellectual property rights for all material on Larven. All
    intellectual property rights are reserved. You may access this from Larven
    for your own personal use subjected to restrictions set in these terms and
    conditions.
        </p>
        <p>You must not:</p>
        <ul>
          <li>Republish material from Larven</li>
          <li>Sell, rent or sub-license material from Larven</li>
          <li>Reproduce, duplicate or copy material from Larven</li>
          <li>Redistribute content from Larven</li>
        </ul>
        <p>
    ...
    opinions and information in certain areas of the website. Larven Syndicate
    ...
    Larven Syndicate Limited,its agents and/or affiliates. Comments reflect the
    views and opinions of the person who post their views and opinions. To the
    extent permitted by applicable laws, Larven Syndicate Limited shall not be
    ...
    appearance of the Comments on this website.
        ...
        <p>
    Larven Syndicate Limited reserves the right to monitor all Comments and to
    ...
    causes breach of these Terms and Conditions.
      ...
      present commercial activities or unlawful activity.
        ...
        <p>
    You hereby grant Larven Syndicate Limited a non-exclusive license to use,
    ...
    compensates the absence of Larven Syndicate Limited; and (d) the link is in
    ...
    e-mail to Larven Syndicate Limited. Please include your name, your
    ...
    response.
      ...
      site.
        ...
        <p>
    No use of Larven Syndicate Limited&apos;s logo or other artwork will be allowed
