  ...
  return (
    <footer>
      <div className="row justify-between items-center">
        ...
        <ul className="col md:col-auto row row-cols-4 gx-3">
          {socials.map(({ name, icon, url }) => (
            <li key={name}>
              <Link href={url} target="_blank" rel="noopener noreferrer" className="inline-block p-2 bg-green-haze-200 rounded-full cursor-pointer hover:bg-green-haze-300">
                {icon}
              </Link>
            </li>
          ))}
